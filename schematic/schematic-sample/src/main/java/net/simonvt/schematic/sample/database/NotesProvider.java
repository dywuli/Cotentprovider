...
public final class NotesProvider {
  ...
  @TableEndpoint(table = Tables.LISTS, packageName = "net.simonvt.schematic.sample.provider") public static class Lists {
  ...
  @TableEndpoint(table = NotesDatabase.NOTES, packageName = "net.simonvt.schematic.sample.provider") public static class Notes {
...
//  @TableEndpoint(table = Tables.NOTES_TAGS,packageName = "net.simonvt.schematic.sample.provider")
